...
class Drive_Square:
    ...
    def stop_robot(self):
        ...
        rospy.loginfo("Robot Stopped")#!/usr/bin/env python3
...
class Drive_Square:
    ...
    def move_forward(self, distance):
        ...
        # Monitor obstacle detection flag to handle obstacles
        while not rospy.is_shutdown() and self.obstacle_detected:
            rospy.sleep(0.1)  # Check obstacle flag every 0.1 seconds

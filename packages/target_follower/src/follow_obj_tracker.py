...
class TargetFollower:
    ...
    def tag_callback(self, msg):
        ...
        for detection in msg.detections:
            if detection.tag_id == self.stop_sign_id:
                stop_sign_detected = True
                tag_position = detection.transform.translation
                rospy.loginfo("Stop Sign position (x, y, z): (%.2f, %.2f, %.2f)", tag_position.x, tag_position.y, tag_position.z)
